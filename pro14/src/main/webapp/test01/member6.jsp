...
<jsp:setProperty property="id" name="m1" value="fefe"/>
<jsp:setProperty property="pwd" name="m1" value="1234"/>
<jsp:setProperty property="name" name="m1" value="페페"/>
<jsp:setProperty property="email" name="m1" value="fefe@naver.com"/>
